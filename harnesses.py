...
HARNESSES: dict[str, Harness] = {
    "claude-code": Harness(
        ...
        agent_format="md",
        hook_mechanism="command",  # command hooks in settings.json
    ),
    "codex": Harness(
        id="codex",
        label="Codex",
        ...
        agent_format="toml",
        hook_mechanism="command",  # native command hooks in config.toml [hooks]
    ),
    "pi": Harness(
        id="pi",
        label="Pi",
    ...
    "opencode": Harness(
        ...
        hook_mechanism="plugin",  # JS plugins / LSP — exists but not hub-managed
    ),
}
