...
#[tauri::command]
pub async fn bootstrap_run(_selections: BootstrapSelections) -> Result<(), String> {
    tauri::async_runtime::spawn_blocking(move || bootstrap_run_impl(_selections))
        .await
...
fn bootstrap_run_impl(_selections: BootstrapSelections) -> Result<(), String> {
