        ...
        return {
          ...
          fix: [
            <>
              ...
              , or grab the macOS installer from <Mono>python.org/downloads</Mono>{" "}
        ...
        return {
          ...
          fix: [
            <>
              ...
              <Mono>brew install python@3.12</Mono>. No Homebrew? Download the
              macOS installer from <Mono>python.org/downloads</Mono>.
            </>,
            <>
              If macOS just popped its "Install command-line developer tools"
              dialog, accepting it also installs Python 3.
            </>,
            <>
              Then restart Skill Tree, or click <strong>Recheck runtime</strong>{" "}
              below.
            </>,
          ],
        };
