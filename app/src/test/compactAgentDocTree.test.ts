					...
					dir("main", "app/src/main", [
						dir("java", "app/src/main/java", [
							dir("com", "app/src/main/java/com", [
								dir("moonbase", "app/src/main/java/com/moonbase", [
									dir(
										"presentation",
										"app/src/main/java/com/moonbase/presentation",
										[
											dir(
												"board",
												"app/src/main/java/com/moonbase/presentation/board",
												[],
												[
													file(
														"app/src/main/java/com/moonbase/presentation/board/CLAUDE.md",
													),
												],
											),
											dir(
												"capture",
												"app/src/main/java/com/moonbase/presentation/capture",
												[],
												[
													file(
														"app/src/main/java/com/moonbase/presentation/capture/CLAUDE.md",
													),
												],
											),
										],
