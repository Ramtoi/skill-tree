...
export function PermissionsEditor({
	...
	// Discard-confirm for ≥5 staged edits (destructive, no undo). `discardCount`
	// snapshots the number of staged edits for the dialog body.
	...
	return (
		<div className="permissions-section perm-surface" ref={sectionRef}>
					...
					<ResizableSplit
						...
						<main className="perm-main">
							<div className="perm-list" aria-label="Permission rows">
								...
								<div className="perm-hooks-moved" role="note">
									...
									<span>
										...
										surface — author, attach, and detach them there.
									</span>
								</div>
							</div>
						</main>
			...
			<ConfirmDialog
				...
				body={
					<p>
						This drops <strong>{discardCount}</strong> staged edit
						{discardCount === 1 ? "" : "s"} and reverts to the last saved
...
function PermissionsStatHero({
	...
	const order: RuleKind[] = ["allow", "deny", "ask"];
	return (
